...
def predict():
    ...
    return render_template('index.html', result1=result1,result2=result2,result3=result3,description1=description1,description2=description2,description3=description3,result_image1=result_image[key1],result_image2=result_image[key2],result_image3=result_image[key3])
